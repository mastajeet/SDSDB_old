<?PHP
// il faut ramasser dans REQUEST les valeurs qui pourraient nous intï¿œresser.
...
if(isset($_GET['MenuCat']) && $_GET['MenuCat']=="Employe"){
    ...
    $MainOutput->CloseCol();
    $MainOutput->OpenCol('230',2);
    $MainOutput->AddLink('index.php?MenuSection=Add_Qualif','Ajouter une qualification');
    $MainOutput->CloseCol();
    $MainOutput->CloseRow();
    ...
    $MainOutput->CloseCol();
    $MainOutput->OpenCol('230',2);
    $MainOutput->AddLink('index.php?MenuSection=BoniCrush','Bonus Crusher');
    $MainOutput->CloseCol();
    $MainOutput->CloseRow();
    ...
    $MainOutput->CloseCol();
    $MainOutput->OpenCol('230',2);
    $MainOutput->AddLink('index.php?MenuSection=Next_WorkingDay&ToPrint=TRUE','Prochain Shift','_BLANK');
    $MainOutput->CloseCol();
    $MainOutput->CloseRow();
        ...
        if($Rep[2]>=1){
            ...
            if(isset($_GET['MenuClient']) AND $_GET['MenuClient']==$Rep[0]){
                ...
                while($Rep2 = $SQL2->FetchArray()){
                    ...
                    $MainOutput->CloseCol();
                    $MainOutput->OpenCol(20);
                    $Installations = get_associated_cote($Rep2[0]);
