<?php
    ...
    const INCOMPLETE_PERIOD = 'Vous ne pouvez pas faire la facturation pour une période non complètée';
    const HOLIDAY = " Journée Fériée";
    const SECOND_LIFEGUARD = "Deuxième Sauveteur";
    const FIRST_LIFEGUARD = "Sauveteur";
    const NO_GET_ROUTE_FOUND = "Aucune Route de tracée pour la Requete GET : ";
