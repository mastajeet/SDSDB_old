...
//    }
    ...
    function test_save_insert()
    {
        ...
        $this->assertEquals("INSERT INTO inspection(`IDInstallation`, `DateR`, `Chaloupe`, `NotesConstruction`) VALUES (25, 12365478, 1, 'okay')", $inspection->save());
    }
