 ...
 * Time: 13:26
 */
const SHIFT_NON_FACTURES = 'Shift n\'ayant pas �t� factur�';
const MARK_SHIFT_AS_BILLED = 'Marquer shift comme factur�s';
const GENERATE_FULL_BILL = 'G�n�rer la facture totale';
