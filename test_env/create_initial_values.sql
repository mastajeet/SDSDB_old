...
INSERT INTO `facture` (`IDFacture`, `Cote`, `Sequence`, `BonAchat`, `TPS`, `TVQ`, `STotal`, `Debit`, `Credit`, `Notes`, `Semaine`, `Paye`, `Utilise`, `EnDate`, `Materiel`, `AvanceClient`) VALUES
  ...
  (1339, 'TDF', 3,  '', 0.05, 0.095, 300, 1,0, '', 1529812800, 0,0, 1530627972, 0, 0), # normale-payee
  (1340, 'TDF', 4,  '', 0.05, 0.095,  10, 1,0, '', 1529812800, 0,0, 1530627972, 0, 0), # materiel
  (1341, 'TDF', 5,  '', 0.05, 0.095, 100, 1,0, '', 1529812800, 0,0, 1530627972, 0, 0), # materiel-payee
  (1342, 'TDF', 6,  '', 0.05, 0.095, 400, 1,0, '', 1529812800, 0,0, 1530627972, 0, 0), # normale-creditee
  (1343, 'TDF', 7,  '', 0.05, 0.095, 500, 1,0, '', 1529812800, 1,0, 1530627972, 0, 0), # normale partiellement-payee
  (1344, 'TDF', 8,  '', 0.05, 0.095, 500, 1,0, '', 1529812800, 0,0, 1530627972, 0, 0), # normale partiellement-creditee
  (1345, 'TDF', 9,  '', 0.05, 0.095, 100, 1,0, '', 1529812800, 0,0, 1530627972, 0, 0), # normale payee dans un pmt a 2 facture avec debalance
  (1346, 'TDF', 10, '', 0.05, 0.095, 100, 1,0, '', 1529812800, 0,0, 1530627972, 0, 0), # normale payee dans un pmt a 2 facture avec debalance

  (1347, 'TDF', 1, '', 0.05, 0.095, -400, 0,1, '', 1529812800, 1,0, 1530627972, 0, 0), # credit pour TDF-6
  (1348, 'TDF', 2, '', 0.05, 0.095, -400, 0,1, '', 1529812800, 1,0, 1530627972, 0, 0), # credit pour TDF-8
  ...
  (1352, 'TF', 2, '', 0.05, 0.095, 400, 0,1, '', 1529812800, 1,0, 1530627972, 1, 0), # Test Facture - credit
...
INSERT INTO `paiement` (`IDPaiement`, `Cote`, `Montant`, `Date`, `PayableYear`,`Notes`) VALUES
  ...
  (100, 'TDF', 344.92, 1530629972,2018, ' Paye:~TDF-3~'),    # paiement complet facture normale
  (101, 'TDF', 114.97, 1530629972,2018, ' Paye:~TDF-5~'),    # paiement complet facture materiel
  (102, 'TDF', 200, 1530629972,2018, ' Paye:~TDF-7~'),       # paiement partiel facture normale
  (103, 'TDF', 200, 1530629972,2018, ' Paye:~TDF-9~TDF-10'), # paiement partiel pour deux factures
