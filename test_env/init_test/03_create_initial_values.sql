...
INSERT INTO `facture` (`IDFacture`, `Cote`, `Sequence`, `BonAchat`, `TPS`, `TVQ`, `STotal`, `Debit`, `Credit`, `Notes`, `Semaine`, `Paye`, `Utilise`, `EnDate`, `Materiel`, `AvanceClient`,`Interest`,`Monthly`) VALUES
(2256, 'PCV', 13, '', 0.05, 0.095, 3692.43, 1,0, '1st installment for lifeguard pool service contract', 1527393600, 1,0, 1527535405, 0, 0, 0, 0),
(2298, 'PCV', 14, '', 0.05, 0.095, 100.51, 1,0, '', 1529812800, 0, 0,1530627972, 0, 0, 0, 0),
(23  , 'ABC', 68, '', 0.05, 0.095, 100.51, 1,0, '', 1529812800, 0, 0,1530627972, 0, 0, 0, 0),

(1337, 'TDF', 1,  '', 0.05, 0.095, 100, 1,0, '', 1509220851, 1,0, 1509220851, 0, 0, 0, 0), # date de 2017
(1338, 'TDF', 2,  '', 0.05, 0.095, 200, 1,0, '', 1529812800, 0,0, 1530627972, 0, 0, 0, 0), # normale
(1339, 'TDF', 3,  '', 0.05, 0.095, 300, 1,0, '', 1529812800, 1,0, 1530627973, 0, 0, 0, 0), # normale-payee
(1340, 'TDF', 4,  '', 0.05, 0.095,  10, 1,0, '', 1529812800, 0,0, 1530627974, 0, 0, 0, 0), # materiel
(1341, 'TDF', 5,  '', 0.05, 0.095, 100, 1,0, '', 1529812800, 1,0, 1530627975, 0, 0, 0, 0), # materiel-payee
(1342, 'TDF', 6,  '', 0.05, 0.095, 400, 1,0, '', 1529812800, 0,0, 1530627976, 0, 0, 0, 0), # normale-creditee
(1343, 'TDF', 7,  '', 0.05, 0.095, 500, 1,0, '', 1529812800, 1,0, 1530627977, 0, 0, 0, 0), # normale partiellement-payee
(1344, 'TDF', 8,  '', 0.05, 0.095, 500, 1,0, '', 1529812800, 0,0, 1530627978, 0, 0, 0, 0), # normale partiellement-creditee
(1345, 'TDF', 9,  '', 0.05, 0.095, 100, 1,0, '', 1529812800, 1,0, 1530627978, 0, 0, 0, 0), # normale payee dans un pmt a 2 invoice avec debalance
(1346, 'TDF', 10, '', 0.05, 0.095, 100, 1,0, '', 1529812800, 1,0, 1530627978, 0, 0, 0, 0), # normale payee dans un pmt a 2 invoice avec debalance

(1347, 'TDF', 1, '', 0.05, 0.095, -400, 0,1, '', 1529812800, 1,0, 1530627977, 0, 0, 0, 0), # credit pour TDF-6
(1348, 'TDF', 2, '', 0.05, 0.095, -400, 0,1, '', 1529812800, 1,0, 1530627979, 0, 0, 0, 0), # credit pour TDF-8
(2349, 'TDF', 11, '', 0.05, 0.095, 100, 1,0, '', 1583625600, 0,0, 1584014400, 0, 0, 0, 0), # 12/3/2020
(2350, 'TDF', 12, '', 0.05, 0.095, 200, 1,0, '', 1583625600, 1,0, 1584014400, 0, 0, 0, 0), # 12/3/2020
(2351, 'TDF', 13, '', 0.05, 0.095, 300, 1,0, '', 1583625600, 0,0, 1584014400, 0, 0, 0, 0), # 12/3/2020
(2352, 'TDF', 14, '', 0.05, 0.095, 400, 1,0, '', 1587254400, 0,0, 1587384000, 0, 0, 0, 0), # 20/4/2020
(2353, 'TDF', 15, '', 0.05, 0.095, 500, 1,0, '', 1587254400, 1,0, 1587384000, 0, 0, 0, 0), # 20/4/2020

(2000, 'TDF', 1, '', 0, 0, 200, 0,0, '', 1529812800, 0,0, 1530627972, 0, 1, 0, 0), # AvanceClient non utilisee
(2001, 'TDF', 2, '', 0, 0, 400, 0,0, '', 1529812800, 0,1, 1530627972, 0, 1, 0, 0), # AvanceClient utilisee

(1349, 'TF', 1, '', 0.05, 0.095, 400, 1,0, '', 1529812800, 1,0, 1530627972, 0, 0, 0, 0), # Test Facture - Facture payee
(1350, 'TF', 2, '', 0.05, 0.095, 400, 1,0, '', 1529812800, 0,0, 1530627972, 0, 0, 0, 0), # Test Facture - Facture non payee
(1353, 'TF', 3, '', 0.05, 0.095, 400, 1,0, '', 1529812800, 1,0, 1530627972, 0, 0, 0, 0), # Test Facture - Facture payee
(1359, 'TF', 4, '', 0.05, 0.095, 100, 1,0, '', 1529812800, 0,0, 1530627972, 1, 0, 0, 0), # Test Facture - Materiel non payée
(1351, 'TF', 1, '', 0.05, 0.095, -400,0,1, '', 1529812800, 1,0, 1530627972, 0, 0, 0, 0), # Test Facture - credit
(1360, 'TF', 7, '', 0.05, 0.095, 0, 1,0, '', 1529812800, 0,0, 1530627972, 1, 0, 0, 0), # Facture Materiel avec mauvais solde (0 vs 510)

(1353, 'TPM', 1, '', 0.05, 0.095, 100, 1,0, '', 1529812800, 1,0, 1530627972, 0, 0, 0, 0), # Test Payment - paye total (1/1)
(1354, 'TPM', 2, '', 0.05, 0.095, 200, 1,0, '', 1529812800, 1,0, 1530627972, 0, 0, 0, 0), # Test Payment - paye total (1/2)
(1355, 'TPM', 4, '', 0.05, 0.095, 300, 1,0, '', 1529812800, 1,0, 1530627972, 0, 0, 0, 0), # Test Payment - paye partiel (1/1)
(1356, 'TPM', 5, '', 0.05, 0.095, 400, 1,0, '', 1529812800, 1,0, 1530627972, 0, 0, 0, 0), # Test Payment - paye partiel (1/2)
(1357, 'TPM', 6, '', 0.05, 0.095, 500, 1,0, '', 1529812800, 1,0, 1530627972, 0, 0, 0, 0), # Test Payment - paye partiel (2/2)
(1358, 'TPM', 3, '', 0.05, 0.095, 600, 1,0, '', 1529812800, 1,0, 1530627972, 0, 0, 0, 0), # Test Payment - paye total (2/2)

(3000, 'TFS', 1, '', 0.05, 0.095, 100, 1,0, '', 1529812800, 1,0, 1530627972, 0, 0, 0, 0), # Facture Shift 1
(3001, 'TFS', 2, '', 0.05, 0.095, 200, 1,0, '', 1529812800, 1,0, 1530627972, 0, 0, 0, 0), # Facture Materiel 1
(3002, 'TFS', 3, '', 0.05, 0.095, 600, 1,0, '', 1529812800, 1,0, 1530627972, 0, 0, 0, 0), # Facture Materiel 2
(3003, 'TFS', 4, '', 0.05, 0.095, 300, 1,0, '', 1529812800, 1,0, 1530627972, 0, 0, 0, 0), # Facture Shift 2
(3004, 'TFS', 1, '', 0.05, 0.095, -400, 1,0, '', 1529812800, 1,0, 1530627972, 0, 0, 0, 0), # Credit 1
(3005, 'TFS', 2, '', 0.05, 0.095, -500, 1,0, '', 1529812800, 1,0, 1530627972, 0, 0, 0, 0), # Credit 2

(3006, 'TFS', 1, '', 0.05, 0.095, 400, 1,0, '', 1529812800, 1,0, 1530627972, 0, 0, 0, 0), # Avance Client 1
(3007, 'TPS', 1, '', 0.05, 0.095, 400, 1,0, '', 1529812800, 1,0, 1530627972, 0, 0, 0, 0), # Facture payee par le paiement

(3010, 'TFF', 1, '', 0.05, 0.095, 400, 1,0, '', 1529812800, 0,0, 1530627972, 0, 0, 0, 0), # Facture shift
(3011, 'TFF', 2, '', 0.05, 0.095, 400, 1,0, '', 1529812800, 0,0, 1530627972, 1, 0, 0, 0), # Facture materiel
(3012, 'TFF', 3, '', 0.05, 0.095, -400, 1,1, '', 1529812800, 0,0, 1530627972, 0, 0, 0, 0), # credit
(3013, 'TFF', 4, '', 0.05, 0.095, 400, 1,0, '', 1529812800, 0,0, 1530627972, 0, 1, 0, 0), # avance client
(3015, 'TFF', 5, '', 0.05, 0.095, 400, 1,0, '', 1529812800, 0,0, 1530627972, 0, 0, 1, 0), # Facture Intérêt

(4001, 'TII', 1, '', 0.05, 0.095, 300, 1,0, '', 1583625600, 0,0, 1584014400, 0, 0, 0, 0), # Facture de temps avec 3 invoice items
(4002, 'TII', 1, '', 0.05, 0.095, 400, 1,0, '', 1583625600, 0,0, 1584014400, 1, 0, 1, 0), # Facture de matériel avec 3 invoice items

(3014, 'RMB', 1, '', 0.05, 0.095, 400, 1,0, '', 1529812800, 0,0, 1530627972, 0, 0, 0, 1), # Facture pour client mensuel avec outstading Balance
(3015, 'RHB', 4, '', 0.05, 0.095, 400, 1,0, '', 1529812800, 0,0, 1530627972, 0, 0, 0, 0); # Facture pour client hebdo avec outstading Balance
